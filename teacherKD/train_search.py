...
def main():
  ...
  for epoch in range(start_epoch, args.epochs):
    ...
    # training
    train_acc, train_obj = train(train_queue, valid_queue, student_model, teacher_model, architect, optimizer, lr)
  ...
  # save the results:
    with open(result_file, 'a') as f:
      writer = csv.writer(f)
      writer.writerow([epoch, valid_acc, train_acc, train_obj])



def train(train_queue, valid_queue, student_model, teacher_model, architect, optimizer, lr):
  ...
  for step, (input, target) in enumerate(train_queue):
    ...
    loss, logits = student_model.compute_loss(input, target, teacher_model, True)
