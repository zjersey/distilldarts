...
primitives_6 = OrderedDict([('primitives_normal', 14 * [PRIMITIVES_woNONE]),
                            ('primitives_reduct', 14 * [PRIMITIVES_woNONE])])
...
spaces_dict = {
    ...
    's3': primitives_3,
    's4': primitives_4,
    'darts': primitives_5, # original DARTS space
    'darts_without_none': primitives_6
}
