...
class Network_selfKD(nn.Module):
    ...
    def forward(self, input):
        ...
        return featureMaps , logits_set


    def compute_loss(self, input, target, return_logits=False):
        featureMaps , logits_set = self(input)
        ...
        if not return_logits:
            ...
            return [loss, CEloss, KLloss, FMloss] , logits_set
    """
    ...
    def _fmloss(self, featureMaps):
        ...
        for i in range(1,len(featureMaps[:-1])):
            ...
            featureMap = F.avg_pool2d(featureMap, featureM/ap.shape[2] // final_layer.shape[2])
